...
import { KewajibanSuamiTerhadapIstri } from '@/constants/HakKewajiban'
import { Fragment } from 'react'
import clsx from 'clsx'
import { arabic } from '@/pages/_app'

const KewajibanSuami = () => {
	return (
		<Page>
				...
				<Flex gap={'4'} direction={'column'}>
					...
					<Card>
						<Text as="p" className="mx-6 my-3 font-semibold">
							Berikut merupakan kewajiban suami terhadap istri pada lingkup keluarga yang telah dijelaskan oleh KH. Hasyim Asy’ari pada
							kitab Dau’ul Misbah fi ahkami Nikah:
						</Text>
						<ol className="list-decimal mx-6 my-6">
							<Flex direction={'column'} gap={'2'}>
								{KewajibanSuamiTerhadapIstri.map((item, idx) => (
									<Fragment key={`${idx}`}>
