...
import { HakIstriTerhadapSuami } from '@/constants/HakKewajiban'
				...
				<Flex gap={'4'} direction={'column'}>
					...
					<Card>
						<Text as="p" className="mx-6 my-3 font-semibold">
							Berikut merupakan hak-hak istri terhadap suami pada lingkup keluarga yang telah dijelaskan oleh KH. Hasyim Asy’ari pada kitab
							Dau’ul Misbah fi ahkami Nikah:
						</Text>
						<ol className="list-decimal mx-6 my-6">
							<Flex direction={'column'} gap={'2'}>
								{HakIstriTerhadapSuami.map((item, idx) => (
									<Fragment key={`${idx}`}>
